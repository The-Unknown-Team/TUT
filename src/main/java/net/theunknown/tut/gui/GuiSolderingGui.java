...
package net.theunknown.tut.gui;

import org.lwjgl.opengl.GL11;
import org.lwjgl.input.Keyboard;

import net.theunknown.tut.procedure.ProcedureSolderingguiFunction;
...
public class GuiSolderingGui extends ElementsTUT.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiSolderingGui(ElementsTUT instance) {
		super(instance, 25);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 62, 12) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 44, 30) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 62, 30) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 80, 30) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 62, 48) {
			}));
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 125, 30) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				TUT.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("tut:textures/solderinggui.png");
		@Override
		...
		protected void actionPerformed(GuiButton button) {
			TUT.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (slotID == 5 && changeType == 1) {
			{
				...
				ProcedureSolderingguiFunction.executeProcedure($_dependencies);
			}
		}
	}
}
