...
public class GuiTe extends ElementsTUT.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiTe(ElementsTUT instance) {
		super(instance, 69);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("tut:textures/te.png");
		@Override
