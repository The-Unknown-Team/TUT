...
public class StructureUranium235vein extends ElementsTUT.ModElement {

	public StructureUranium235vein(ElementsTUT instance) {
		super(instance, 50);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 250000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("tut", "uranium235"));
				if (template == null)
					return;
